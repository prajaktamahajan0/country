...
const countrycard = (arr) => {
      let result = '';
      arr.forEach(obj => {

            result += `<div class="col-sm-6 col-md-3 mt-4">
                      <div class="thumbnail cardimg">
                      <figure>
                     <img src="${obj.flag}" alt="img">
                        </figure>
                       <div class="caption ">
                        <h3>${obj.name}</h3>
                        <p> Capital: <span>${obj.capital}</span></p>
                        <p> Languages: <span> ${obj.languages}</span></p>
...
const onkeyup = (eve) => {
      ...
      let searchCountry = eve.target.value;
      cl(searchCountry)

      let filterarr = countries.filter(ele => ele.name.includes(searchCountry));
      countrycard(filterarr)
}
const onclickName = (eve) => {
      let sortname = countries.sort((country1, country2) => {
            let p = country1.name.toLowerCase().join('');
            let m = country2.name.toLowerCase().join('');
            if (p < m) {
                  return -1
            } if (p > m) {
                  return 1
      ...
      if (flag === true) {
            countrycard(sortname)
            flag = false;
      } else {
            countrycard(sortname.reverse())
            flag = true;
      }

}
const onclickcapital = (eve) => {
      let capital = countries.sort((a, b) => {
            let p = a.capital;
            let m = b.capital;
            if (p < m) {
                  return -1
      ...
      if (flag === true) {
            ...
            countrycard(capital.reverse())
            flag = true;
      }
}
const onclickpopulation = (eve) => {
      ...
      if (flag === true) {
            countrycard(populationclick)
            flag = false;
      } else {
            countrycard(populationclick.reverse())
            flag = true;
      }
}
